...
We accept contributions via pull requests on [GitHub](http://github.com/fortuneglobe/types).

## Issues

- Please report issues here on [GitHub](http://github.com/fortuneglobe/types/issues)
